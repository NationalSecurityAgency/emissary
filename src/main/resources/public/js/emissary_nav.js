$(document).ready(function () {
    ...
    $('ul.navbar-nav.mr-auto').append('<li class="nav-item"><a class="nav-link" href="/">API</a></li>');
    $('ul.navbar-nav.mr-auto').append('<li class="nav-item"><a class="nav-link" href="/emissary/Document.action">Document</a></li>');
    ...
    $('ul.navbar-nav.mr-auto').append('<li class="nav-item"><a class="nav-link" href="/emissary/Console.action">Console</a></li>');
