...
public class Agents {
    ...
    @Operation(summary = "Get a list of locally running agents", tags = {"agents"})
    ...
    @Path("/cluster/agents")
    @Produces(MediaType.APPLICATION_JSON)
    @Operation(summary = "Get a list of running agents across the cluster", tags = {"agents", "cluster"})
