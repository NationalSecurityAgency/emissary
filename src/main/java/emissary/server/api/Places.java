...
public class Places {
    ...
    @Operation(summary = "Get a list of running places for a server", tags = {"places"})
    ...
    @Path("/cluster/places")
    @Produces(MediaType.APPLICATION_JSON)
    @Operation(summary = "Get a list of running places across the cluster", tags = {"places", "cluster"})
