...
public class Peers {
    ...
    @Operation(summary = "Get the list of configured servers", tags = {"peers"})
    ...
    @Path("/cluster/peers")
    @Produces(MediaType.APPLICATION_JSON)
    @Operation(summary = "Get the list of configured servers across the cluster", tags = {"peers", "cluster"})
