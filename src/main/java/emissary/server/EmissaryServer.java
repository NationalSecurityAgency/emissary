...
import emissary.place.RefreshableServiceProviderPlace;
...
public class EmissaryServer {
    ...
    public static void refresh(final boolean silent) throws NamespaceException {
        ...
        Namespace.lookup(RefreshableServiceProviderPlace.class, silent).forEach(RefreshableServiceProviderPlace::invalidate);
    ...
    private static void handleRefresh() {
        try {
            ...
            Namespace.lookup(RefreshableServiceProviderPlace.class).forEach(RefreshableServiceProviderPlace::refresh);
            unpause();
        } catch (Exception e) {
    ...
    private static void waitForAgentsToDrain() throws NamespaceException, TimeoutException {
        ...
        try {
            ...
            LOG.info("Waiting for server to drain");
            do {
