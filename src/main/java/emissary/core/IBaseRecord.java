...
public interface IBaseRecord {
     ...
     * the {@link IBaseRecord#setData(byte[]) setData(byte[])}, {@link IBaseRecord#setData(byte[], int, int) setData(byte[],
     * int, int)}, or {@link IBaseRecord#setChannelFactory(SeekableByteChannelFactory)
