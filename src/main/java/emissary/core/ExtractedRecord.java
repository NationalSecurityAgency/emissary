 ...
 */
public class ExtractedRecord implements Serializable, Cloneable, Remote, IExtractedRecord {
     ...
     */
    public ExtractedRecord(final byte[] newData, final String name) {
        setData(newData);
        setFilename(name);
        setCreationTimestamp(Instant.now());
    }
     ...
     */
    public ExtractedRecord(final byte[] newData, final String name, @Nullable final String form) {
        this(newData, name);
        if (form != null) {
    ...
    public ExtractedRecord(final byte[] newData, final String name, final String form, @Nullable final String fileType) {
