...
public class DataObjectFactory {
     ...
     * @deprecated Initialisation of data is preferred to use stream based mechanisms after initialisation
     */
    @Deprecated
     ...
     * @return an IBDO with the payload, filename, set with the file type and form set to the same value
     */
    public static IBaseDataObject get(final String filename, final String fileTypeAndForm) {
        return getInstance(filename, fileTypeAndForm, fileTypeAndForm);
    }
     ...
     * @return an IBDO with the payload, filename, file type, and form set
     */
    public static IBaseDataObject get(final String filename, final String form, final String fileType) {
        final Object o = Factory.create(CLAZZ, filename, form, fileType);
        return (IBaseDataObject) o;
    }
}
