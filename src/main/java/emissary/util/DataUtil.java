...
public class DataUtil {
    ...
    /**
     * Return true if the data slot is empty or just blank space and/or control chars
     */
    ...
    /**
     * Return true if the data is empty or consists only of blank space or control characters
     * 
    ...
    /**
     * Return true if the data slot is empty or just one blank space character
     */
