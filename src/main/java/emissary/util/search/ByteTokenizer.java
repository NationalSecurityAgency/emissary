...
public class ByteTokenizer implements Enumeration<String> {
    ...
    /**
     * Constructs a byte tokenizer for the specified byte array. All characters in the <code>delim</code> argument are
     * the delimiters for separating tokens. Characters must be in the range of 0 - 255.
     * <p>
    ...
    /**
     * Constructs a byte tokenizer for the specified byte array. The characters in the <code>delim</code> argument are
    ...
    public boolean hasMoreTokens() {
        /*
         * Temporary store this position and use it in the following nextToken() method only if the delimiters haven't
     ...
     * delimiters by this <tt>ByteTokenizer</tt> object is changed to be the characters in the string <tt>delim</tt>.
