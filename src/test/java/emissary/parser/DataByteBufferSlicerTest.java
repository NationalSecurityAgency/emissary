...
class DataByteBufferSlicerTest extends UnitTest {
    ...
    void testSinglePositionRecord() {
        ...
        assertEquals("11111", new String(result, UTF_8), "Byte buffer slice with one position record");
    }
    ...
    void testSingleMultipleRecord() {
        ...
        assertEquals("111112222233333", new String(result, UTF_8), "Byte buffer slice with one position record");
    }
