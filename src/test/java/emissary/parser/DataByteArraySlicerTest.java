...
class DataByteArraySlicerTest extends UnitTest {
    ...
    void testSpliceMultiplePositionRecords() {
        ...
        assertEquals("111112222233333", new String(result), "Result of multiple position records splicing");
    }
    ...
    void testSpliceSinglePositionRecord() {
        ...
        byte[] input = "000000000011111xxxxx22222yyyyy33333zzzzzqqqqqqqqqqqqqq".getBytes();
        byte[] result = DataByteArraySlicer.makeDataSlice(input, pr);
        assertEquals("11111", new String(result), "Result of single position records splicing");
    }
